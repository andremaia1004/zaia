        ...
        <div className="p-8 max-w-7xl mx-auto h-[calc(100vh-2rem)] flex flex-col">
            <header className="flex items-center justify-between mb-8 shrink-0">
                <div className="flex items-center gap-3">
                    <div className="p-2 bg-zaia-500/20 rounded-xl">
                        <CalendarIcon className="w-6 h-6 text-zaia-400" />
                    </div>
                ...
                <div className="flex items-center gap-4">
                    <div className="flex bg-white/5 rounded-xl border border-white/5 overflow-hidden p-1">
                        <button
                            onClick={prevMonth}
                    ...
                    {calendarDays.map((day, idx) => {
                        ...
                        return (
                            <div
                                key={day.toString()}
                                className={clsx(
                                    "border-r border-b border-white/5 p-2 flex flex-col gap-1 transition-colors hover:bg-white/[0.02] last:border-r-0",
                                            ...
                                            className={clsx(
                                                ...
                                                task.status === 'FEITA'
                                                    ...
                                                    : task.status === 'ADIADA'
                                                        ...
                                                        : "bg-zaia-500/10 text-zaia-400 border-zaia-500/20"
                                            )}
                                            title={task.title}
                                        >
                                            {task.title}
